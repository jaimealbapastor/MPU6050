...
void getButtonState(int bStatus)
{
  ...
  // -----------------  BUTTON #1  -----------------------
  case 'A':
    buttonStatus |= B000001; // ON - les autres boutons ne sont pas touch̩s (1)

    power = true; // ON

    break;
  case 'B':
    buttonStatus &= B111110; // OFF - les autres boutons ne sont pas touch̩s (1)
...
// Fonction qui arr̻te / d̩marre les 2 moteurs
void motorPowerOff()
{
